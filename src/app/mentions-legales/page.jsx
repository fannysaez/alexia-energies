        ...
        <div className={styles.container}>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.text}>
                    ...
                    <strong>Propriétaire :</strong> Alexia Anduskiewicz – 21 Grand’ Rue 63440 Villars-sur-Var<br />
                    <strong>Création du site web :</strong> Anis<br />
                    <strong>Responsable publication :</strong> Alexia Anduskiewicz – contact@alexia-magnetiseuse.fr<br />
                    <strong>Webmaster :</strong> Anis – anis.dev@gmail.com<br />
